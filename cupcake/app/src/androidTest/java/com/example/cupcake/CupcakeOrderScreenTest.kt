...
import com.example.cupcake.onNodeWithStringId
...
class CupcakeOrderScreenTest {
    ...
    fun selectOptionScreen_optionSelected_NextButtonEnabled() {
        // Given list of options
        val flavours = listOf("Vanilla", "Chocolate", "Hazelnut", "Cookie", "Mango") // on met des nvl valeurs dans les flavor pr voir si affichera avec des valeurs differnetes
        // And sub total
        val subTotal = "$100"
