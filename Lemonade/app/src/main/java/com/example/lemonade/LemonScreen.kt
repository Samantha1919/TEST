...
fun LemonScreen(
    ...
    val images = listOf(R.drawable.lemon_squeeze, R.drawable.lemon_drink, R.drawable.lemon_restart) // 0 1 2
    val textes: List<String> = listOf("Keep tapping the lemon to squeeze it", "Tap the lemonade to drink it", "Tap the empty glass to start again")
    ...
    Column(
        ...
        Text(
            ...
            modifier = Modifier.padding(top = 16.dp), // la jai mis du padding sur lautre g mis un Spacer pr montrer 2 exemples
