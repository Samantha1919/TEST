...
fun ReplyDetailsScreen(
    ...
    isFullScreen: Boolean = false // permet de différencier le composable lorsqu'il est utilisé de manière autonome et lorsqu'il est utilisé dans l'écran d'accueil
) {

    BackHandler {
        onBackPressed() // pr appuyer sur la fleche de retour
    }
