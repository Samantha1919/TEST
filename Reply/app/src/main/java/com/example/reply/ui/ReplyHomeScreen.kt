    ...
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER && replyUiState.isShowingHomepage) {
        ...
        PermanentNavigationDrawer(
            ...
            ReplyAppContent(
                ...
                replyUiState = replyUiState, // permet de naviguer entre différents écrans sans avoir a utiliser la classe NavHostController
                onTabPressed = onTabPressed,
...
private fun ReplyAppContent(
...

    {
        Row(modifier = Modifier.fillMaxSize()) {
            AnimatedVisibility(visible = navigationType == ReplyNavigationType.NAVIGATION_RAIL) { // gere les animations
